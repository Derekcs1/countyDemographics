...
def render_main():
    ...
    if 'State' in request.args:
        ...
        return render_template('home.html', response_options = get_state_options(counties), response_population = percentUnder18(counties, selected_state), response_state = selected_state)
